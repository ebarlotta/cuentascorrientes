...
$ID = $_GET['ID'];
$query = "SELECT tblElementosDescartables.id, tblElementosDescartables.IdResidente, tblPacientes.NombrePaciente, tblElementosDescartables.Anio, tblElementosDescartables.Mes, tblElementosDescartables.Elemento, tblElementosDescartables.Fecha, tblElementosDescartables.Debe, tblElementosDescartables.Haber, tblElementosDescartables.Detalle, tblElementosDescartables.Cantidad, tblElementosDescartables.PrecioUnitario, tblElementosDescartables.Pendiente, tblElementosDescartables.Preferencia FROM tblElementosDescartables, tblPacientes WHERE tblElementosDescartables.Pendiente=1 and tblElementosDescartables.Elemento='Descartables' and tblElementosDescartables.IdResidente=$ID and tblElementosDescartables.IdResidente=tblPacientes.IdPaciente ORDER BY Anio, Mes, Fecha";
...
$item->title = "Descartables utilizados" . " - " . $row['NombrePaciente'];
$item->quantity = 1;
