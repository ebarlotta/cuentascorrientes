...
$query="INSERT INTO tblElementosDescartables (IdResidente, Anio, Mes, Elemento, Fecha, Debe, Haber, Detalle, Cantidad, PrecioUnitario, Pendiente, Preferencia) VALUES ($ID, $Ano,$Mes,'Insumos','$Fecha',0,$saldoParcial, 'MercadoPago', $CantidadParcial,0,0,'$preference')";
$resultInsert = mysqli_query($link, $query);

$query = "UPDATE tblElementosDescartables SET Pendiente=0 WHERE IdResidente=$ID and Elemento='Insumos'";
