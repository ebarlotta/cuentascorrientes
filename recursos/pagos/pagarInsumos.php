...
$preference->back_urls = array(
    "success" => "http://barberdesarrollos.com/cuentascorrientes/recursos/pagos/aprobadoInsumos.php?id=".$preference->id."&IDR=".$ID,
...
$item->title = "Insumos médicos utilizados" . " - " . $row['NombrePaciente'];
$item->quantity = 1;
...
<body ng-controller="ElementosController" ng-init="Cargar_detalle_panales(<?php echo $ID; ?>);">
    <div id="header-featured">
        ...
        <strong>
            <table class="table table-striped" style="color:beige;background: rgba(95, 179, 119, 0.5); margin-bottom: 25px; font-size:1em;">
                <tr>
